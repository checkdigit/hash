...
describe('hash', () => {
  ...
  it('hash always returns the same value', () => {
    ...
    assert.equal(
      hash('d1253ec1-14bc-4c56-8e09-4450ab4c8a55'),
      '14abff19-2c5f-5408-af3d-3c6526ebea73',
    );
    ...
    assert.equal(
      // eslint-disable-next-line no-secrets/no-secrets
      hash('nfv8yFRghIJV6ffFr2dJGi1978GPnUuc7JVi2/FPqHE='),
      'e90938db-61fb-55b4-8ebe-4e1518e4fe97',
    );

    assert.equal(
      // eslint-disable-next-line @checkdigit/no-card-numbers
      hash('5111111111111118'),
      '87e25c4b-c395-585e-9ecf-43d190f6e62f',
    );
    assert.equal(
      hash('https://checkdigit.com'),
      '2c391f52-ec24-5945-8c28-88f74d12b55d',
    );
  });
});
